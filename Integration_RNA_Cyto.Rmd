...
```{r}
pls.results <- pls(X = X1, Y = X3) #ncomp par defaut -> 2
pls.results
```
...
spls.results <- mixOmics::spls(X1, X3, ncomp = 2, keepX = keepX, keepY = keepY)
spls.results
```
